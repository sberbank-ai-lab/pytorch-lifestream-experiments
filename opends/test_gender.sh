...
python ml_inference.py params.device="cuda:2" dataset.clip_transactions.min_len=75    dataset.clip_transactions.max_len=150  output.path="../data/gender/embeddings_0150"  trx_features.path="../data/gender/trx_features_0150"  --conf conf/gender_dataset.hocon conf/gender_ml_params_inference.json
python ml_inference.py params.device="cuda:2" dataset.clip_transactions.min_len=50    dataset.clip_transactions.max_len=100  output.path="../data/gender/embeddings_0100"  trx_features.path="../data/gender/trx_features_0100"  --conf conf/gender_dataset.hocon conf/gender_ml_params_inference.json
python ml_inference.py params.device="cuda:2" dataset.clip_transactions.min_len=25    dataset.clip_transactions.max_len=50   output.path="../data/gender/embeddings_0050"  trx_features.path="../data/gender/trx_features_0050"  --conf conf/gender_dataset.hocon conf/gender_ml_params_inference.json
python ml_inference.py params.device="cuda:2" dataset.clip_transactions.min_len=12    dataset.clip_transactions.max_len=25   output.path="../data/gender/embeddings_0025"  trx_features.path="../data/gender/trx_features_0025"  --conf conf/gender_dataset.hocon conf/gender_ml_params_inference.json
...
python -m scenario_gender compare_approaches --ml_embedding_file_names "trx_features.pickle" "trx_features_1000.pickle" "trx_features_2000.pickle"
